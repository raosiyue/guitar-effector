...
float doreverb_new(float sample){
	ap1.update_para(&ap1, ap1_len, 0.7 );
	ap2.update_para(&ap2, ap2_len, 0.7 );
	ap3.update_para(&ap3, ap3_len, 0.7 );
	fbcf1.update_para(&fbcf1, cf1_len *g_effect_controller.reverb_time, -0.805 );
	fbcf2.update_para(&fbcf2, cf2_len *g_effect_controller.reverb_time, -0.827 );
	fbcf3.update_para(&fbcf3, cf3_len*g_effect_controller.reverb_time, -0.783 );
	fbcf4.update_para(&fbcf4, cf4_len *g_effect_controller.reverb_time, -0.764);
